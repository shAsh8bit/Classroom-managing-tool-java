...
class UpdateStudent implements ActionListener{
    ...
    JFrame f;
    JLabel id,id1,id2,id3,id4,id5,id6,id7,id8,id9,id10,id11,id12,id15,lab,lab1,lab2,l1;
	...
	try{
        ...
        l1 = new JLabel("Enter roll number to update the data of student");
        l1.setBounds(50,100,500,30);
        l1.setFont(new Font("berlin sans FB",Font.PLAIN,20));
       
        
        o1.setBounds(500,100,200,30);
        f.add(o1);
        f.add(l1);
        ...
        id8.setFont(new Font("broadway",Font.BOLD,35));
        ...
        id1.setFont(new Font("berlin sans FB",Font.PLAIN,20));
        f.add(id1);
        ...
        id2.setFont(new Font("berlin sans FB",Font.PLAIN,20));
        f.add(id2);
        ...
        id3.setFont(new Font("berlin sans FB",Font.PLAIN,20));
        f.add(id3);
        ...
        id4.setFont(new Font("berlin sans FB",Font.PLAIN,20));
        f.add(id4);
        ...
        id5.setFont(new Font("berlin sans FB",Font.PLAIN,20));
        f.add(id5);
        ...
        id6.setFont(new Font("berlin sans FB",Font.PLAIN,20));
        f.add(id6);
        ...
        id7.setFont(new Font("berlin sans FB",Font.PLAIN,20));
        f.add(id7);
        ...
        id9.setFont(new Font("berlin sans FB",Font.PLAIN,20));
        f.add(id9);
        ...
        id10.setFont(new Font("berlin sans FB",Font.PLAIN,20));
        f.add(id10);
        ...
        id11.setFont(new Font("berlin sans FB",Font.PLAIN,20));
        f.add(id11);
        ...
        id12.setFont(new Font("berlin sans FB",Font.PLAIN,20));
        f.add(id12);
	...
	lab.setFont(new Font("berlin sans FB",Font.PLAIN,20));
        f.add(lab);
	...
	lab2.setFont(new Font("berlin sans FB",Font.PLAIN,20));
        f.add(lab2);
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource()==b){
            try{
                conn con = new conn();
                String str = "update student set name='"+t1.getText()+"',fathers_name='"+t2.getText()+"',age='"+t3.getText()+"', dob='"+t4.getText()+"',address='"+t5.getText()+"',phone='"+t6.getText()+"',email='"+t7.getText()+"',class_x='"+t8.getText()+"',class_xii='"+t9.getText()+"',aadhar='"+t10.getText()+"',rollno='"+t11.getText()+"',course='"+t13.getText()+"',branch='"+t14.getText()+"' where rollno='"+o1.getSelectedItem()+"'";
        ...
        if(ae.getSource() == b2){
            try{
                conn con = new conn();
                String str = "select * from student where rollno = '"+o1.getSelectedItem()+"'";
