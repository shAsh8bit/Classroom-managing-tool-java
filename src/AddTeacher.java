...
class AddTeacher implements ActionListener{
    ...
    AddTeacher(){
        ...
        id15.setLayout(null);
        ImageIcon img = new ImageIcon(ClassLoader.getSystemResource("university/management/system/icons/addtea.png"));
        Image i3 = img.getImage().getScaledInstance(920, 1100,Image.SCALE_DEFAULT);
        ImageIcon icc3 = new ImageIcon(i3);
        id15.setIcon(icc3);
       

        id8 = new JLabel("New Teacher Details");
        id8.setBounds(250,50,500,50);
        ...
        id8.setFont(new Font("berlin sans FB",Font.PLAIN,20)); 
        id15.add(id8);
	...
	lab2.setFont(new Font("berlin sans FB",Font.PLAIN,20));
        ...
        b.setBackground(new Color(73, 49, 49));
        b.setForeground(Color.WHITE);
        b.setBounds(150,550,150,40);
        
        id15.add(b);

        b1=new JButton("Cancel");   
        b1.setBackground(new Color(73, 49, 49));
