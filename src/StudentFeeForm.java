...
public class StudentFeeForm extends JFrame implements ActionListener{
	...
	comboBox_2.setFont(new Font("berlin sans FB",Font.PLAIN, 14));
	...
	b1.setBounds(64, 321, 111, 33);
        b1.setBackground(new Color(187, 244, 253));
	...
	b2.setBounds(198, 321, 111, 33);
        b2.setBackground(new Color(187, 244, 253));
        b2.setForeground(Color.black);
	contentPane.add(b2);

	JLabel l7 = new JLabel("Course");
	l7.setForeground(new Color(25, 25, 112));
	l7.setFont(new Font("berlin sans FB",Font.PLAIN, 14));
	...
	comboBox_3.setFont(new Font("berlin sans FB",Font.PLAIN, 14));
	comboBox_3.setBounds(176, 176, 154, 20);
	contentPane.add(comboBox_3);

	JPanel panel = new JPanel();
	panel.setBorder(new TitledBorder(new LineBorder(new Color(187, 244, 253), 3, true), "FEE FORM",
			TitledBorder.LEADING, TitledBorder.TOP, null, new Color(255, 51, 51)));
	panel.setBackground(new Color(211, 211, 211));
	panel.setBounds(10, 25, 358, 348);
